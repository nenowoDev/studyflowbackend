...
('admin01', "password", 'admin', 'Admin User', 'admin@example.com', NULL, NULL, 'https://placehold.co/128x128/9CA3AF/1F2937?text=Admin');

-- Lecturers
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('lecturer01', "password", 'lecturer', 'Dr. Alice Smith', 'alice.smith@university.edu', NULL, NULL, 'https://placehold.co/128x128/90CDF4/2B6CB0?text=A.S.');
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('lecturer02', "password", 'lecturer', 'Prof. Bob Johnson', 'bob.j@university.edu', NULL, NULL, 'https://placehold.co/128x128/A7F3D0/065F46?text=B.J.');

-- Academic Advisors
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('advisor01', "password", 'advisor', 'Ms. Carol White', 'carol.w@university.edu', NULL, NULL, 'https://placehold.co/128x128/FDE68A/92400E?text=C.W.');
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('advisor02', "password", 'advisor', 'Mr. David Green', 'david.g@university.edu', NULL, NULL, 'https://placehold.co/128x128/D1FAE5/065F46?text=D.G.');

-- Students
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('student1', "password", 'student', 'Emily Brown', 'emily.b@student.university.edu', 'A20EC0001', '1234', 'https://placehold.co/128x128/FECACA/B91C1C?text=E.B.');
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('student2', "password", 'student', 'Frank Miller', 'frank.m@student.university.edu', 'A20EC0002', '5678', 'https://placehold.co/128x128/DBEAFE/1E40AF?text=F.M.');
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('student3', "password", 'student', 'Grace Davis', 'grace.d@student.university.edu', 'A20EC0003', '9012', 'https://placehold.co/128x128/D1FAE5/065F46?text=G.D.');
INSERT INTO `users` (`username`, `password_hash`, `role`, `full_name`, `email`, `matric_number`, `pin`, `profile_picture`) VALUES
('student4', "password", 'student', 'Henry Wilson', 'henry.w@student.university.edu', 'A20EC0004', '3456', 'https://placehold.co/128x128/FFEDD5/9A3412?text=H.W.');
